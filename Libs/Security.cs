...
namespace Libs
{
    ...
    public partial class RijndaelEnhanced
    {
    ...
    public class Encrypt
    {
        ...
        public static string GetToken()
        {
            ...
            {
                return Encrypt.MD5(System.Web.HttpContext.Current.Session["accessToken"].ToString());
            }
            return Encrypt.MD5(DateTime.Now.ToShortDateString());
        }
    }
}